          ...
          {loading ? (
            <div className="flex justify-center items-center h-full py-12">
              <div className="flex flex-col items-center">
                <div className="relative">
                  ...
                  <div
                    className="animate-spin rounded-full h-10 w-10 border-t-2 border-green-400 absolute top-0 left-0"
            ...
            <div className="w-full flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-gray-300 font-medium">
                No trending products selected
              </p>
              <p className="text-gray-500 text-sm mt-1 max-w-sm">
                Add products to showcase in the Trending section of your
                homepage
              </p>
              <button
      ...
      <div className="bg-green-900/20 border border-green-700/30 rounded-lg px-4 py-3 text-green-200 text-sm flex items-start">
        ...
        <div>
          <p className="font-medium mb-1">
            Trending products drive customer engagement
          </p>
          <p className="text-green-300 opacity-80">
            These products will be displayed in the Trending section of your
            homepage. Choose popular items that are getting significant
            attention.
          </p>
        </div>
      </div>
