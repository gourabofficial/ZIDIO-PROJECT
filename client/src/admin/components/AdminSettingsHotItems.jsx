...
const AdminSettingsHotItems = ({ selectedIds = [], onSave }) => {
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg">
      <h2 className="text-xl font-semibold text-white mb-4">Hot Items</h2>
      <p className="text-gray-400 mb-4">Enter product IDs for hot items section (comma-separated)</p>
