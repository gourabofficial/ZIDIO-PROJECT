...
const AddProduct = () => {
  ...
  const collections = [
    ...
    'Fall Collection', 'Holiday Collection', 'Limited Edition'
  ];
  ...
  const categories = [
    'Mervel', 'superman', 'Batman', 'spiderman', 
  ...
  const validate = () => {
    ...
    if (product.sizes.length === 0 && ['Clothing', 'Sports'].includes(product.category))
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className={`relative rounded-md shadow-sm ${errors.name ? 'border-red-500' : ''}`}>
              <input
                ...
                className={`w-full bg-gray-700 border ${errors.name ? 'border-red-500' : 'border-gray-600'} rounded-md py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <textarea
              ...
              onChange={handleChange}
              className={`w-full bg-gray-700 border ${errors.description ? 'border-red-500' : 'border-gray-600'} rounded-md py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
          ...
          <div>
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full bg-gray-700 border ${errors.category ? 'border-red-500' : 'border-gray-600'} rounded-md py-3 pl-10 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
              >
          ...
          <div>
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <input
                ...
                value={product.price}
                onChange={handleChange}
                className={`w-full bg-gray-700 border ${errors.price ? 'border-red-500' : 'border-gray-600'} rounded-md py-3 pl-10 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
                placeholder="0.00"
              />
            </div>
            {errors.price && (
          ...
          <div>
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full bg-gray-700 border ${errors.discount ? 'border-red-500' : 'border-gray-600'} rounded-md py-3 pl-10 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
                placeholder="0"
              />
            </div>
            {errors.discount && (
            ...
            {product.price && product.discount && (
              <p className="mt-1 text-sm text-gray-400">
                Final price: ₹{(parseFloat(product.price) * (1 - parseFloat(product.discount || 0) / 100)).toFixed(2)}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <input
                ...
                value={product.stock}
                onChange={handleChange}
                className={`w-full bg-gray-700 border ${errors.stock ? 'border-red-500' : 'border-gray-600'} rounded-md py-3 pl-10 px-4 text-white focus:outline-none focus:ring-2 focus:ring-blue-500`}
                placeholder="0"
              />
            </div>
            {errors.stock && (
          ...
          <div className="col-span-1 md:col-span-2">
            <label className="block text-sm font-medium text-gray-300 mb-2">
              Available Sizes {['Clothing', 'Sports'].includes(product.category) && <span className="text-red-400">*</span>}
            </label>
            <div className="flex items-center mb-2">
              <Ruler size={18} className="text-gray-400 mr-2" />
              <span className="text-sm text-gray-400">Select all sizes available for this product</span>
            </div>
            
            <div className={`bg-gray-750 p-3 rounded-md border ${errors.sizes ? 'border-red-500' : 'border-gray-700'}`}>
            ...
            {product.sizes.length > 0 && (
              <p className="mt-1 text-sm text-gray-400">
                {product.sizes.length} size{product.sizes.length > 1 ? 's' : ''} selected
              </p>
            )}
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className={`border-2 border-dashed ${errors.images ? 'border-red-500' : 'border-gray-600'} rounded-lg p-6 text-center`}>
              <div className="flex flex-col items-center">
                <ImageIcon size={48} className="text-gray-500 mb-2" />
                <p className="text-gray-300 mb-2">Drag & drop images here, or click to select files</p>
                <p className="text-gray-400 text-xs mb-4">PNG, JPG or WEBP (Max 5MB each)</p>
                  ...
                  {imagePreview.map((src, index) => (
                    <div key={index} className="relative group">
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 bg-red-600 rounded-full p-1 shadow-md opacity-0 group-hover:opacity-100 transition-opacity"
                      >
