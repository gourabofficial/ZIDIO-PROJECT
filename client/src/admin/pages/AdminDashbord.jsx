...
const DUMMY_DATA = {
  ...
  recentOrders: [
    { id: '1001', customer: 'Alex Johnson', product: 'Wireless Earbuds', amount: 129, status: 'Delivered', date: '2025-04-26' },
    { id: '1002', customer: 'Sarah Williams', product: 'Smart Watch', amount: 249, status: 'Shipped', date: '2025-04-25' },
...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setTimeout(() => {
        setStats(DUMMY_DATA.stats);
        setRecentOrders(DUMMY_DATA.recentOrders);
        setFilteredOrders(DUMMY_DATA.recentOrders);
        setIsLoading(false);
      }, 1000);
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col overflow-hidden">
      ...
      {/* Main content */}
      <div className="flex-1 overflow-y-auto admin-scroll-container">
          ...
          <div className="bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <div className="p-4 sm:p-6 border-b border-gray-700">
              <div className="flex flex-wrap items-center justify-between">
                ...
                <div className="flex items-center mt-2 sm:mt-0 bg-gray-700 rounded-md p-2 w-full md:w-auto">
                  <Search size={18} className="text-gray-400 mr-2" />
                  <input 
                    type="text" 
                    placeholder="Search orders..." 
                    className="bg-transparent border-none text-sm text-white focus:outline-none placeholder-gray-400 flex-1"
                    value={searchTerm}
            ...
            {filteredOrders.length > 0 ? (
              ...
              <div className="text-center py-8 text-gray-400">
                {searchTerm ? 'No orders match your search' : 'No recent orders found'}
              </div>
            )}
          </div>
        </div>
