...
const TrendingProductsPage = ({ trendingProduct }) => {
  ...
  const formattedProducts =
    trendingProduct?.map((product) => ({
      ...
      handle: product.id, // Using _id as handle for navigation
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-3 relative inline-block">
            <span className="text-white">Trending Product</span>
          ...
          <p className="text-gray-400 text-center max-w-2xl">
            ...
            of the curve with our curated selection of trending products.
          </p>
        </div>
