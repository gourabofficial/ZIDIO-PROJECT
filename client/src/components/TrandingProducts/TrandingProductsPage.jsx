...
import TrendingHeader from './TrandingHeader';
import TrendingCategories from './TrendingCategories';
import TrendingProductGrid from './TrandingProductGrid';

import { trendingProducts, trendingCategories } from './TrandingData';
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const filteredProducts = 
        activeCategory === 'all' 
          ? trendingProducts 
          : trendingProducts.filter(product => product.category.includes(activeCategory));
